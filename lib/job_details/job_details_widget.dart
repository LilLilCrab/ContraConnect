...
import '/components/confirm_job_delete_widget.dart';
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JOB_DETAILS_PAGE_arrow_back_ICN_ON_TAP');
                            ...
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JOB_DETAILS_PAGE_edit_ICN_ON_TAP');
                                logFirebaseEvent(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'JOB_DETAILS_PAGE_UPDATE_JOB_BTN_ON_TAP');
                              if (_model.editingMode) {
                                ...
                                await widget.job!.reference
                                  ...
                                  typeOfWork: _model.textController3.text,
                                  startingPrice: _model.textController2.text,
                                ));
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'JOB_DETAILS_PAGE_DELETE_POST_BTN_ON_TAP');
                                ...
                                builder: (context) {
                                  return GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: ConfirmJobDeleteWidget(
                                        jobReference: widget.job!.reference,
                                      ),
                                    ),
                                  );
                                },
