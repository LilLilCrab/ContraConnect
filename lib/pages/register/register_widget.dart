...
class _RegisterWidgetState extends State<RegisterWidget> {
  ...
  void initState() {
    ...
    _model.homeownertoContValue = true;
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Switch.adaptive(
                      value: _model.homeownertoContValue!,
                      onChanged: (newValue) async {
                        safeSetState(
                            () => _model.homeownertoContValue = newValue);
                        if (newValue) {
                          logFirebaseEvent(
                              'REGISTER_HomeownertoCont_ON_TOGGLE_ON');
                          logFirebaseEvent('HomeownertoCont_update_page_state');
                          _model.navOnbHome = !_model.navOnbHome;
                          safeSetState(() {});
                        }
                      },
                      activeColor: FlutterFlowTheme.of(context).tertiary,
                      activeTrackColor: Color(0xFF39B4A2),
                      inactiveTrackColor: Color(0x76EE8B60),
                      inactiveThumbColor:
                          FlutterFlowTheme.of(context).secondaryBackground,
                    ),
                    Text(
                      _model.homeownertoContValue!
                          ? 'I am a Homeowner'
                          : 'I am a Contractor',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.inter(
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('REGISTER_PAGE_Sign-UpButton_ON_TAP');
                        logFirebaseEvent('Sign-UpButton_auth');
                        ...
                        if (_model.homeownertoContValue!) {
                          logFirebaseEvent('Sign-UpButton_navigate_to');

                          context.pushNamedAuth(
                              OnboardingHomeownerWidget.routeName,
                              context.mounted);
                        } else {
                          logFirebaseEvent('Sign-UpButton_navigate_to');

                          context.pushNamedAuth(
                              OnboardingContractorWidget.routeName,
                              context.mounted);
                        }
                      },
                      text: 'Register',
