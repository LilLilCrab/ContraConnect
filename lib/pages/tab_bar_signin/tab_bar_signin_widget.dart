...
import 'tab_bar_signin_model.dart';
export 'tab_bar_signin_model.dart';

class TabBarSigninWidget extends StatefulWidget {
  const TabBarSigninWidget({super.key});

  static String routeName = 'tab_bar_signin';
  static String routePath = '/tabBarSignin';

  @override
  State<TabBarSigninWidget> createState() => _TabBarSigninWidgetState();
}

class _TabBarSigninWidgetState extends State<TabBarSigninWidget>
    with TickerProviderStateMixin {
  late TabBarSigninModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TabBarSigninModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'tab_bar_signin'});
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'TAB_BAR_SIGNIN_PAGE_Sign-InButton_ON_TAP');
                                      ...
                                      if (valueOrDefault<bool>(
                                          ...
                                          false)) {
                                        logFirebaseEvent(
                                            'Sign-InButton_navigate_to');

                                        context.pushNamedAuth(
                                            HomeownerJobsWidget.routeName,
                                            context.mounted);
                                      } else {
                                        logFirebaseEvent(
                                            'Sign-InButton_navigate_to');
                                ...
                                children: [
                                  ...
                                  Switch.adaptive(
                                    ...
                                    onChanged: (newValue) async {
                                      safeSetState(() => _model
                                          .homeownertoContValue = newValue);
                                      if (newValue) {
                                        logFirebaseEvent(
                                            'TAB_BAR_SIGNIN_HomeownertoCont_ON_TOGGLE');
                                        logFirebaseEvent(
                                            'HomeownertoCont_update_page_state');
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'TAB_BAR_SIGNIN_PAGE_Sign-UpButton_ON_TAP');
